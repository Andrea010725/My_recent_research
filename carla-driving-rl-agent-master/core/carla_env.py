...
class CARLAEnv(ThreeCameraCARLAEnvironment):   # 观测空间定义
    ...
    def __init__(self, *args, stack_depth=False, collision_penalty=1000.0, info_every=1, time_horizon=4,
        ...
        image_shape = kwargs.pop('image_shape', (90, 120, 3))    # 图片形状 格式
    ...
    def _get_observation(self, sensors_data: dict) -> dict:     #   观测量
